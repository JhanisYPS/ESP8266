...
#include "Page_10.h" //--> Our HTML webpage contents with javascripts
...
const char* ssid = "Miro";  //--> Your wifi name
const char* password = "jyps2812"; //--> Your wifi password
//----------------------------------------
...
const int LED_D1 = D8; //--> LED to detect when the heart is beating. The LED is connected to PIN D8 (GPIO5) on the NodeMCU ESP12E.
int Threshold = 890; //--> Determine which Signal to "count as a beat" and which to ignore.
